...
//            throw new RuntimeException(Messages.getMessage("noDefaultTypeMapping00"));
    ...
    private String[] getParamNames(Method method) {
        // Parameter names are only used for informational purposes, they were
        // calculated parsing generated bytecode, which causes problems if it
        // has been compiled in recent JDKS.
        return null;
    }
